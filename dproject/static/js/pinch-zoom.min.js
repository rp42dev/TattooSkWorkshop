    ...
    value: function (a) {
        ...
        for (var b, c = Object(a), d = 1; d < arguments.length; d++)
            if (b = arguments[d], null != b)
                for (var e in b) Object.prototype.hasOwnProperty.call(b, e) && (c[e] = b[e]);
        return c
    },
    writable: !0,
    configurable: !0
...
var buildElement = function (a) {
    ...
    definePinchZoom = function () {
        ...
        d.prototype = {
            ...
            bindEvents: function () {
                var a = this;
                g(this.container, this), this.resizeHandler = this.update.bind(this), window.addEventListener("resize", this.resizeHandler), Array.from(this.el.querySelectorAll("img")).forEach(function (b) {
                    b.addEventListener("load", a.update.bind(a))
                }), "IMG" === this.el.nodeName && this.el.addEventListener("load", this.update.bind(this))
            },
            update: function (a) {
                a && "resize" === a.type && (this.updateAspectRatio(), this.setupOffsets()), a && "load" === a.type && (this.updateAspectRatio(), this.setupOffsets());
                this.updatePlanned || (this.updatePlanned = !0, window.setTimeout(function () {
